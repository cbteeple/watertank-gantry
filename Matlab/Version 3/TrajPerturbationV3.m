function TrajPerturbationV3(N_Trials, xF, yF, zF, xH, yH, zH, nSteps, fx_type,PosError,feedRate,file_name)
    ...
    for i=0:1:N_Trials-1 %Discrete steps in the x direction
        for j=0:1:N_Trials-1 %Discrete steps in the y direction
            for k = 0:1:N_Trials-1 %Discrete steps in the z direction
                ...
                %defined as PosError
                [xi,yj,zk] = TrajectoryGeneratorV3(xF - PosError + ...
                ...
                TrajToGCodeV3(xi,yj,zk,feedRate,nSteps,i_name)
        end
    end
end