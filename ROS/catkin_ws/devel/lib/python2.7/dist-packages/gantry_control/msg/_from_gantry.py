...
"""autogenerated by genpy from gantry_control/from_gantry.msg. Do not edit."""
import sys
...
class from_gantry(genpy.Message):
  _md5sum = "462b18e0de79f571e404f9b05e3ff8d0"
  _type = "gantry_control/from_gantry"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string response
float32[] position
"""
  __slots__ = ['response','position']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(from_gantry, self).__init__(*args, **kwds)
